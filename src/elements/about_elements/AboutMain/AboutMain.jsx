  ...
  return (
    <div style={{display:"flex", width:"100vw", height:"70vh", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
        ...
        <div style={{display:"flex", width:"96vw", height:"65vh", flexDirection:"row"}}>
            <div style={{display:"flex", width:"48vw", height:"42vh", flexDirection:"column", padding:"2vh", margin:"2vh", backgroundColor:"#004677", borderRadius:"1.75vw"}}>
            ...
            <div style={{display:"flex", width:"48vw", height:"42vh", flexDirection:"column", padding:"2vh", margin:"2vh", backgroundColor:"#147BD1", borderRadius:"1.75vw"}}>
